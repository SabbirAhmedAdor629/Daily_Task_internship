...
type Message struct {
	...
	CallToActionmsg         string       `json:"call_to_action_msg"`
	...
	BonusmsgName            string       `json:"bonus_msg_name"`
	BonusmsgCount           json.Number  `json:"bonus_msg_count"`
	BonusmsgCounter         json.Number  `json:"bonus_msg_counter"`
...
func main() {
	...
	jsondata := `{
		...
		"bonus_completed_at" : "",
		"bonus_msg_name" : "engage_install_server",
		"bonus_msg_count" : 0,
		"bonus_msg_counter" : 0,
		"bonus_type" : "prize"
	}`
	...
	if err == nil {
		...
		fmt.Println("\n")
		fmt.Println("Status : ", msg.PushMessages.Status)
		fmt.Println("ProviderMessageID : ", msg.PushMessages.ProviderMessageID)
		fmt.Println("PushProvider :", msg.PushMessages.PushProvider)
		fmt.Println("CreatedAt : ", msg.PushMessages.CreatedAt)
		fmt.Println("UpdatedAt : ", msg.PushMessages.UpdatedAt)
		fmt.Println("GUID : ", msg.PushMessages.GUID)
		fmt.Println("\n")
		...
		fmt.Println("BonusmsgName : ", msg.BonusmsgName)
		fmt.Println("BonusmsgCount : ", msg.BonusmsgCount)
		fmt.Println("BonusmsgCounter : ", msg.BonusmsgCounter)
