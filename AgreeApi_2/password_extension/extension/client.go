...
// InitError reports an initialization error to the platform. Call it when you
// registered but failed to initialize
...
// ExitError reports an error to the platform before exiting. Call it when you
// encounter an unexpected failure
